...
export class SignupComponent {
  ...
  SignupForm= new FormGroup({username: new FormControl('@nmdc-group.com', [Validators.required, emailDomainValidator('nmdc-group.com')]), password: new FormControl('', [Validators.required])})
